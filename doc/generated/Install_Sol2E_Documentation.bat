...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Sol2E" /mediaBookList "Documentation of Sol2E Game Engine generated by Sandcastle" /productName "Documentation of Sol2E Game Engine generated by Sandcastle" > NUL
...
IF EXIST "Sol2E_Documentation.msha" COPY /Y "Sol2E_Documentation.msha" HelpContentSetup.msha
...
"%SYSTEMDRIVE%\Program Files\Microsoft Help Viewer\v2.0\HlpCtntMgr.exe" /operation install /catalogName VisualStudio11 /locale en-us /sourceUri "%CD%\Sol2E_Documentation.msha"
